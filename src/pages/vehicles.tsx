...
const Vehicles: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold  text-center flex-grow">Vehicles</h1>
            <br />
            <ul>
                {drivers.map((driver, index) => {
                    ...
                    return (
                        <li key={uniqueKey} className="mb-4 p-4 border rounded shadow">
                            <p className="text-lg font-semibold">{driver.vehicleRegistration}</p>
                            <p>Days Used: {daysWorked}</p>
